...
The `@deprecated tag:v6.8.0` annotations mark most symbols. `WebhookFailureStrategy` is unannotated because
it remains the flag-off default and enum deprecations are not ignored by PHPStan. This list is authoritative.
