...
class WebhookLifecycleEventsTest extends TestCase
{
    ...
    public function testSharedDataAndMailContract(): void
    {
        $event = $this->suspendedEvent('wh-id', 'owner-app');
        ...
        $this->expectExceptionObject(new MailEventConfigurationException(
            'Data for mailRecipientStruct not available.',
